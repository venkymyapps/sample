...
public class EmployeeDAOImpl implements EmployeeDAO {
	...
	public int createEmployee(Employee employee) {
		boolean value = entityManager
				...
				.setParameter("companyName", employee.getCompany().getName()).setParameter("gender", employee.getGender())
				...
				.setParameter("cityName", employee.getcity().getName()).setParameter("country", employee.getCountry())
